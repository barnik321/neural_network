...
from network.common import np
import sklearn
from sklearn.model_selection import train_test_split

from network.constants import Defaults, Losses as loss_fn_names
from network.functions import loss as loss_functions
...
class Model:
    ...
    def predict(self, x):
        return np.asnumpy(self._predict(x))
